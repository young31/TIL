...
"""
for frame, ex in ssafy['language']['python']['frameworks'].items():
    print(f'{frame}는 {ex}이다.')
...
"""
import random
# name = random.choice((ssafy['classes']['dj']['groups']['E']))
# print(f'오늘의 당번은 {name}')

print(f"오늘의 당번은 {random.choice((ssafy['classes']['dj']['groups']['E']))}")
# '' // "" 중복 오류 이슈